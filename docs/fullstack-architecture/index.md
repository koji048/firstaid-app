...
- [First Aid Room App Fullstack Architecture Document](#table-of-contents)
  ...
  - [Data Models](./data-models.md)
    ...
    - [EmergencyContact Model](./data-models.md#emergencycontact-model)
    - [FirstAidGuide Model](./data-models.md#firstaidguide-model)
    - [MedicalProfile Model](./data-models.md#medicalprofile-model)
  - [API Specification](./api-specification.md)
    - [REST API Specification](./api-specification.md#rest-api-specification)
  - [Components](./components.md)
    - [Mobile App (React Native)](./components.md#mobile-app-react-native)
    - [Auth Service (Lambda)](./components.md#auth-service-lambda)
    - [Content Service (Lambda)](./components.md#content-service-lambda)
    - [Emergency Service (Lambda)](./components.md#emergency-service-lambda)
    - [Medical Profile Service (Lambda)](./components.md#medical-profile-service-lambda)
    - [Notification Service (Lambda)](./components.md#notification-service-lambda)
  ...
  - [External APIs](./external-apis.md)
    ...
    - [Apple Push Notification Service (APNS)](./external-apis.md#apple-push-notification-service-apns)
